...
// export interface ProduceChildHandler{
//     target:any;
//     eventHandler:()=>Node | null;
// }

@ccclass('UIRecycleScrollView')
export class UIRecycleScrollView extends Component {
    @property(ScrollView)
    ...
    protected onLoad() {
        ...
        this.scrollView.node.on(ScrollView.EventType.SCROLL_ENDED, () => game.frameRate = 45, this)
        if (this.item) {
